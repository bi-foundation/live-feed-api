...
func (m *AdminBlockHeader) GetBlockHeight() uint64 {
	if m != nil {
...
func (*AdminBlockEntry_DbSignatureEntry) isAdminBlockEntry_AdminBlockEntry()                   {}
...
func (m *AdminBlockEntry) GetDbSignatureEntry() *DirectoryBlockSignatureEntry {
	if x, ok := m.GetAdminBlockEntry().(*AdminBlockEntry_DbSignatureEntry); ok {
...
func _AdminBlockEntry_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// adminBlockEntry
	switch x := m.AdminBlockEntry.(type) {
	...
	case nil:
	default:
		return fmt.Errorf("AdminBlockEntry.AdminBlockEntry has unexpected type %T", x)
	}
	return nil
}
...
func _AdminBlockEntry_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*AdminBlockEntry)
	switch tag {
	case 1: // adminBlockEntry.addAuditServer
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddAuditServer)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddAuditServer{msg}
		return true, err
	case 2: // adminBlockEntry.addEfficiency
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddEfficiency)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddEfficiency{msg}
		return true, err
	case 3: // adminBlockEntry.addFactoidAddress
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddFactoidAddress)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddFactoidAddress{msg}
		return true, err
	case 4: // adminBlockEntry.addFederatedServer
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddFederatedServer)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddFederatedServer{msg}
		return true, err
	case 5: // adminBlockEntry.addFederatedServerBitcoinAnchorKey
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddFederatedServerBitcoinAnchorKey)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddFederatedServerBitcoinAnchorKey{msg}
		return true, err
	case 6: // adminBlockEntry.addFederatedServerSigningKey
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddFederatedServerSigningKey)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddFederatedServerSigningKey{msg}
		return true, err
	case 7: // adminBlockEntry.addReplaceMatryoshkaHash
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AddReplaceMatryoshkaHash)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_AddReplaceMatryoshkaHash{msg}
		return true, err
	case 8: // adminBlockEntry.cancelCoinbaseDescriptor
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CancelCoinbaseDescriptor)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_CancelCoinbaseDescriptor{msg}
		return true, err
	case 9: // adminBlockEntry.coinbaseDescriptor
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CoinbaseDescriptor)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_CoinbaseDescriptor{msg}
		return true, err
	case 10: // adminBlockEntry.dbSignatureEntry
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DirectoryBlockSignatureEntry)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_DbSignatureEntry{msg}
		return true, err
	case 11: // adminBlockEntry.endOfMinuteEntry
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(EndOfMinuteEntry)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_EndOfMinuteEntry{msg}
		return true, err
	case 12: // adminBlockEntry.forwardCompatibleEntry
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ForwardCompatibleEntry)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_ForwardCompatibleEntry{msg}
		return true, err
	case 13: // adminBlockEntry.increaseServerCount
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(IncreaseServerCount)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_IncreaseServerCount{msg}
		return true, err
	case 14: // adminBlockEntry.removeFederatedServer
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RemoveFederatedServer)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_RemoveFederatedServer{msg}
		return true, err
	case 15: // adminBlockEntry.revealMatryoshkaHash
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RevealMatryoshkaHash)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_RevealMatryoshkaHash{msg}
		return true, err
	case 16: // adminBlockEntry.serverFault
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ServerFault)
		err := b.DecodeMessage(msg)
		m.AdminBlockEntry = &AdminBlockEntry_ServerFault{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *AddAuditServer) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type AddEfficiency struct {
	IdentityChainID      *Hash    `protobuf:"bytes,1,opt,name=identityChainID,proto3" json:"identityChainID,omitempty"`
	Efficiency           uint64   `protobuf:"varint,2,opt,name=efficiency,proto3" json:"efficiency,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AddEfficiency) GetEfficiency() uint64 {
	if m != nil {
		return m.Efficiency
	}
	return 0
...
func (m *AddFederatedServer) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type AddFederatedServerBitcoinAnchorKey struct {
	IdentityChainID      *Hash    `protobuf:"bytes,1,opt,name=identityChainID,proto3" json:"identityChainID,omitempty"`
	KeyPriority          uint64   `protobuf:"varint,2,opt,name=keyPriority,proto3" json:"keyPriority,omitempty"`
	KeyType              uint64   `protobuf:"varint,3,opt,name=keyType,proto3" json:"keyType,omitempty"`
...
func (m *AddFederatedServerBitcoinAnchorKey) GetKeyPriority() uint64 {
	if m != nil {
...
func (m *AddFederatedServerBitcoinAnchorKey) GetKeyType() uint64 {
	if m != nil {
		return m.KeyType
	}
	return 0
...
func (m *AddFederatedServerSigningKey) GetKeyPriority() uint64 {
	if m != nil {
		return m.KeyPriority
	}
	return 0
...
func (m *AddFederatedServerSigningKey) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type CancelCoinbaseDescriptor struct {
	DescriptorHeight     uint64   `protobuf:"varint,1,opt,name=descriptorHeight,proto3" json:"descriptorHeight,omitempty"`
	DescriptorIndex      uint64   `protobuf:"varint,2,opt,name=descriptorIndex,proto3" json:"descriptorIndex,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CancelCoinbaseDescriptor) GetDescriptorHeight() uint64 {
	if m != nil {
...
func (m *CancelCoinbaseDescriptor) GetDescriptorIndex() uint64 {
	if m != nil {
...
type EndOfMinuteEntry struct {
	MinuteNumber         uint64   `protobuf:"varint,1,opt,name=minuteNumber,proto3" json:"minuteNumber,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *EndOfMinuteEntry) GetMinuteNumber() uint64 {
	if m != nil {
...
func (m *ForwardCompatibleEntry) GetSize_() uint64 {
	if m != nil {
		return m.Size_
	}
	return 0
...
func (m *IncreaseServerCount) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *RemoveFederatedServer) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
type ServerFault struct {
	...
	VmIndex              uint64           `protobuf:"varint,4,opt,name=vmIndex,proto3" json:"vmIndex,omitempty"`
...
func (m *ServerFault) GetVmIndex() uint64 {
	if m != nil {
		return m.VmIndex
	}
	return 0
...
func (m *ServerFault) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
func (m *ServerFault) GetHeight() uint64 {
	if m != nil {
		return m.Height
	}
	return 0
...
var fileDescriptor_974412be9cb81647 = []byte{
	...
	,
}
...
func (this *AdminBlockEntry_DbSignatureEntry) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AdminBlockEntry_DbSignatureEntry)
	if !ok {
		that2, ok := that.(AdminBlockEntry_DbSignatureEntry)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.DbSignatureEntry.Equal(that1.DbSignatureEntry) {
		return false
	}
	return true
}
...
func (this *DirectoryBlockSignatureEntry) Equal(that interface{}) bool {
	...
	if !this.PrevDBSig.Equal(that1.PrevDBSig) {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
...
func (g *AdminBlockEntry_DbSignatureEntry) GetDirectoryBlockSignatureEntry() *DirectoryBlockSignatureEntry {
	return g.DbSignatureEntry
}
...
func init() {
	...
	GraphQLDirectoryBlockSignatureEntryType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		...
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				...
				"PrevDBSig": &github_com_graphql_go_graphql.Field{
					Type:        GraphQLSignatureType,
					Description: "",
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						obj, ok := p.Source.(*DirectoryBlockSignatureEntry)
						if ok {
							if obj.PrevDBSig == nil {
								return nil, nil
							}
							return obj.GetPrevDBSig(), nil
						}
						inter, ok := p.Source.(DirectoryBlockSignatureEntryGetter)
						if ok {
							face := inter.GetDirectoryBlockSignatureEntry()
							...
							if face.PrevDBSig == nil {
								return nil, nil
							}
							return face.GetPrevDBSig(), nil
						}
						return nil, fmt.Errorf("field PrevDBSig not resolved")
					},
				},
			}
		}),
	...
	GraphQLServerFaultType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		...
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				...
				"height": &github_com_graphql_go_graphql.Field{
					Type:        github_com_graphql_go_graphql.Int,
					Description: "",
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						obj, ok := p.Source.(*ServerFault)
						...
						if ok {
							...
							return face.Height, nil
						}
						return nil, fmt.Errorf("field height not resolved")
					},
				},
	...
	GraphQLAdminBlockEntryAdminBlockEntryUnion = github_com_graphql_go_graphql.NewUnion(github_com_graphql_go_graphql.UnionConfig{
		...
		ResolveType: func(p github_com_graphql_go_graphql.ResolveTypeParams) *github_com_graphql_go_graphql.Object {
			...
			if _, ok := p.Value.(*AdminBlockEntry_DbSignatureEntry); ok {
...
func (m *AdminBlockHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PreviousBackRefHash != nil {
		...
		n2, err := m.PreviousBackRefHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *AdminBlockEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdminBlockEntry != nil {
		nn3, err := m.AdminBlockEntry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn3
...
func (m *AdminBlockEntry_AddAuditServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddAuditServer != nil {
		...
		n4, err := m.AddAuditServer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *AdminBlockEntry_AddEfficiency) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddEfficiency != nil {
		...
		n5, err := m.AddEfficiency.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *AdminBlockEntry_AddFactoidAddress) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddFactoidAddress != nil {
		...
		n6, err := m.AddFactoidAddress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *AdminBlockEntry_AddFederatedServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddFederatedServer != nil {
		...
		n7, err := m.AddFederatedServer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *AdminBlockEntry_AddFederatedServerBitcoinAnchorKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddFederatedServerBitcoinAnchorKey != nil {
		...
		n8, err := m.AddFederatedServerBitcoinAnchorKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *AdminBlockEntry_AddFederatedServerSigningKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddFederatedServerSigningKey != nil {
		...
		n9, err := m.AddFederatedServerSigningKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *AdminBlockEntry_AddReplaceMatryoshkaHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AddReplaceMatryoshkaHash != nil {
		...
		n10, err := m.AddReplaceMatryoshkaHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *AdminBlockEntry_CancelCoinbaseDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CancelCoinbaseDescriptor != nil {
		...
		n11, err := m.CancelCoinbaseDescriptor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *AdminBlockEntry_CoinbaseDescriptor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CoinbaseDescriptor != nil {
		...
		n12, err := m.CoinbaseDescriptor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *AdminBlockEntry_DbSignatureEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DbSignatureEntry != nil {
		...
		n13, err := m.DbSignatureEntry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *AdminBlockEntry_EndOfMinuteEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EndOfMinuteEntry != nil {
		...
		n14, err := m.EndOfMinuteEntry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *AdminBlockEntry_ForwardCompatibleEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ForwardCompatibleEntry != nil {
		...
		n15, err := m.ForwardCompatibleEntry.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *AdminBlockEntry_IncreaseServerCount) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IncreaseServerCount != nil {
		...
		n16, err := m.IncreaseServerCount.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *AdminBlockEntry_RemoveFederatedServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RemoveFederatedServer != nil {
		...
		n17, err := m.RemoveFederatedServer.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *AdminBlockEntry_RevealMatryoshkaHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RevealMatryoshkaHash != nil {
		...
		n18, err := m.RevealMatryoshkaHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
...
func (m *AdminBlockEntry_ServerFault) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ServerFault != nil {
		...
		n19, err := m.ServerFault.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *AddAuditServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		n20, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *AddEfficiency) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n21, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *AddFactoidAddress) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n22, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *AddFederatedServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n24, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
...
func (m *AddFederatedServerBitcoinAnchorKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n25, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
...
func (m *AddFederatedServerSigningKey) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n26, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *AddReplaceMatryoshkaHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n27, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.MatryoshkaHash != nil {
		...
		n28, err := m.MatryoshkaHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *DirectoryBlockSignatureEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityAdminChainID != nil {
		...
		n29, err := m.IdentityAdminChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.PrevDBSig != nil {
		...
		n30, err := m.PrevDBSig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *RemoveFederatedServer) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n31, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *RevealMatryoshkaHash) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IdentityChainID != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.IdentityChainID.Size()))
		n32, err := m.IdentityChainID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.MatryoshkaHash != nil {
		...
		i++
		i = encodeVarintAdminBlock(dAtA, i, uint64(m.MatryoshkaHash.Size()))
		n33, err := m.MatryoshkaHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *ServerFault) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ServerId != nil {
		...
		n35, err := m.ServerId.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.AuditServerId != nil {
		...
		n36, err := m.AuditServerId.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func NewPopulatedAdminBlockEntry(r randyAdminBlock, easy bool) *AdminBlockEntry {
	...
	case 10:
		this.AdminBlockEntry = NewPopulatedAdminBlockEntry_DbSignatureEntry(r, easy)
	case 11:
...
func NewPopulatedAdminBlockEntry_DbSignatureEntry(r randyAdminBlock, easy bool) *AdminBlockEntry_DbSignatureEntry {
	this := &AdminBlockEntry_DbSignatureEntry{}
	this.DbSignatureEntry = NewPopulatedDirectoryBlockSignatureEntry(r, easy)
	return this
}
...
func NewPopulatedAddEfficiency(r randyAdminBlock, easy bool) *AddEfficiency {
	...
	this.Efficiency = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedAdminBlock(r, 3)
	}
	return this
...
func NewPopulatedAddFederatedServerBitcoinAnchorKey(r randyAdminBlock, easy bool) *AddFederatedServerBitcoinAnchorKey {
	...
	this.KeyPriority = uint64(uint64(r.Uint32()))
	this.KeyType = uint64(uint64(r.Uint32()))
	v2 := r.Intn(100)
...
func NewPopulatedAddReplaceMatryoshkaHash(r randyAdminBlock, easy bool) *AddReplaceMatryoshkaHash {
	...
	if r.Intn(10) != 0 {
		v4 := r.Intn(5)
		this.Outputs = make([]*TransactionAddress, v4)
		for i := 0; i < v4; i++ {
...
func NewPopulatedCancelCoinbaseDescriptor(r randyAdminBlock, easy bool) *CancelCoinbaseDescriptor {
	...
	this.DescriptorHeight = uint64(uint64(r.Uint32()))
	this.DescriptorIndex = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedAdminBlock(r, 3)
	}
	return this
...
func NewPopulatedCoinbaseDescriptor(r randyAdminBlock, easy bool) *CoinbaseDescriptor {
	...
	if r.Intn(10) != 0 {
		v5 := r.Intn(5)
		this.Outputs = make([]*TransAddress, v5)
		for i := 0; i < v5; i++ {
			this.Outputs[i] = NewPopulatedTransAddress(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedDirectoryBlockSignatureEntry(r randyAdminBlock, easy bool) *DirectoryBlockSignatureEntry {
	...
	if r.Intn(10) != 0 {
		this.PrevDBSig = NewPopulatedSignature(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedAdminBlock(r, 3)
	}
...
func NewPopulatedEndOfMinuteEntry(r randyAdminBlock, easy bool) *EndOfMinuteEntry {
	...
	this.MinuteNumber = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedAdminBlock(r, 2)
	}
	return this
...
func NewPopulatedServerFault(r randyAdminBlock, easy bool) *ServerFault {
	...
	this.VmIndex = uint64(uint64(r.Uint32()))
	this.BlockHeight = uint64(uint64(r.Uint32()))
...
func (m *AdminBlockEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.AdminBlockEntry = &AdminBlockEntry_DbSignatureEntry{v}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Efficiency |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KeyPriority |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DescriptorHeight |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DescriptorIndex |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinuteNumber |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

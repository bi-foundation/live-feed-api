...
func (m *EntryCreditBlockHeader) GetBlockHeight() uint64 {
	if m != nil {
...
type CommitChain struct {
	...
	Credits              uint64           `protobuf:"varint,5,opt,name=credits,proto3" json:"credits,omitempty"`
...
func (m *CommitChain) GetCredits() uint64 {
	if m != nil {
		return m.Credits
	}
	return 0
...
func (m *CommitEntry) GetCredits() uint64 {
	if m != nil {
		return m.Credits
	}
	return 0
...
func (m *MinuteNumber) GetMinuteNumber() uint64 {
	if m != nil {
...
type ServerIndexNumber struct {
	ServerIndexNumber    uint64   `protobuf:"varint,1,opt,name=serverIndexNumber,proto3" json:"serverIndexNumber,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ServerIndexNumber) GetServerIndexNumber() uint64 {
	if m != nil {
...
var fileDescriptor_2805fc15da93467e = []byte{
	...
	,
}
...
func (this *CommitChain) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CommitChain)
	if !ok {
		that2, ok := that.(CommitChain)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CommitEntry) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CommitEntry)
	if !ok {
		that2, ok := that.(CommitEntry)
		if ok {
			that1 = &that2
		} else {
			return false
...
type CommitChainGetter interface {
	GetCommitChain() *CommitChain
}

var GraphQLCommitChainType *github_com_graphql_go_graphql.Object

type CommitEntryGetter interface {
	GetCommitEntry() *CommitEntry
}

var GraphQLCommitEntryType *github_com_graphql_go_graphql.Object
...
func (g *EntryCreditBlockEntry_CommitChain) GetCommitChain() *CommitChain {
	return g.CommitChain
}
func (g *EntryCreditBlockEntry_CommitEntry) GetCommitEntry() *CommitEntry {
...
func init() {
	...
	GraphQLCommitChainType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		Name:        "CommitChain",
		Description: "",
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				"chainIDHash": &github_com_graphql_go_graphql.Field{
					...
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						...
						inter, ok := p.Source.(CommitChainGetter)
						if ok {
							face := inter.GetCommitChain()
							if face == nil {
								return nil, nil
							}
	...
	GraphQLCommitEntryType = github_com_graphql_go_graphql.NewObject(github_com_graphql_go_graphql.ObjectConfig{
		Name:        "CommitEntry",
		Description: "",
		Fields: (github_com_graphql_go_graphql.FieldsThunk)(func() github_com_graphql_go_graphql.Fields {
			return github_com_graphql_go_graphql.Fields{
				"entryHash": &github_com_graphql_go_graphql.Field{
					...
					Resolve: func(p github_com_graphql_go_graphql.ResolveParams) (interface{}, error) {
						...
						inter, ok := p.Source.(CommitEntryGetter)
						if ok {
							face := inter.GetCommitEntry()
							if face == nil {
								return nil, nil
							}
							if face.EntryHash == nil {
...
func NewPopulatedCommitChain(r randyEntryCredit, easy bool) *CommitChain {
	this := &CommitChain{}
	if r.Intn(10) != 0 {
	...
	this.Credits = uint64(uint64(r.Uint32()))
	v3 := r.Intn(100)
...
func NewPopulatedCommitEntry(r randyEntryCredit, easy bool) *CommitEntry {
	this := &CommitEntry{}
	if r.Intn(10) != 0 {
		this.EntryHash = NewPopulatedHash(r, easy)
	}
...
func NewPopulatedServerIndexNumber(r randyEntryCredit, easy bool) *ServerIndexNumber {
	...
	this.ServerIndexNumber = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedEntryCredit(r, 2)
	}
	return this
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ServerIndexNumber |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
